...
### [](#api-changes-text-style-updates)API Changes Text Style Updates
...
### [](#introducing-shouldrerenderontransaction)Introducing `shouldRerenderOnTransaction`
...
### [](#nodeview-changes)NodeView Changes
...
### [](#extensions-package)Extensions Package

The new `@tiptap/extensions` package combines multiple utility extensions:

-   [CharacterCount](/docs/editor/extensions/functionality/character-count)
-   [Dropcursor](/docs/editor/extensions/functionality/dropcursor)
-   [Gapcursor](/docs/editor/extensions/functionality/gapcursor)
-   [History](/docs/editor/extensions/functionality/undo-redo) (now named `UndoRedo`)
-   [Placeholder](/docs/editor/extensions/functionality/placeholder)
-   [TrailingNode](/docs/editor/extensions/functionality/trailing-node)
-   [Focus](/docs/editor/extensions/functionality/focus)
-   [Selection](/docs/editor/extensions/functionality/selection)
...
## [](#starterkit-updates)StarterKit Updates

StarterKit now includes these extensions by default:

-   [Link](/docs/editor/extensions/marks/link)
-   [ListKeymap](/docs/editor/extensions/functionality/listkeymap)
-   [Underline](/docs/editor/extensions/marks/underline)
